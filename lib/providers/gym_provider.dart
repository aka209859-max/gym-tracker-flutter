  ...
  void _loadSampleData() {
    _gyms = [
      Gym(
        ...
        latitude: 35.6895,
        longitude: 139.7006,
        description: AppLocalizations.of(context)!.gym_24時間営業のフィットネスジム初心者から上級者まで幅広く対応,
        facilities: [AppLocalizations.of(context)!.gym_筋トレマシン, AppLocalizations.of(context)!.gym_ランニングマシン, AppLocalizations.of(context)!.gym_フリーウェイト, AppLocalizations.of(context)!.gym_シャワー],
        phoneNumber: '03-1234-5678',
        openingHours: AppLocalizations.of(context)!.gym_24時間営業,
        monthlyFee: 7980,
        rating: 4.5,
        reviewCount: 128,
        ...
        partnerBenefit: AppLocalizations.of(context)!.gym_入会金50OFF初月無料,
      ...
      Gym(
        ...
        latitude: 35.6598,
        longitude: 139.7035,
        description: AppLocalizations.of(context)!.gym_本格的なトレーニング環境を提供する老舗ジム,
        facilities: [AppLocalizations.of(context)!.gym_筋トレマシン, AppLocalizations.of(context)!.gym_フリーウェイト, AppLocalizations.of(context)!.gym_スタジオ, AppLocalizations.of(context)!.gym_サウナ, AppLocalizations.of(context)!.gym_プール],
      ...
      Gym(
        ...
        latitude: 35.7295,
        longitude: 139.7190,
        description: AppLocalizations.of(context)!.gym_総合スポーツクラブプールやスタジオプログラムも充実,
        facilities: [AppLocalizations.of(context)!.gym_筋トレマシン, AppLocalizations.of(context)!.gym_プール, AppLocalizations.of(context)!.gym_スタジオ, AppLocalizations.of(context)!.gym_サウナ, AppLocalizations.of(context)!.gym_スパ, AppLocalizations.of(context)!.gym_テニスコート],
      ...
      Gym(
        ...
        latitude: 35.7072,
        longitude: 139.6656,
        description: AppLocalizations.of(context)!.gym_女性専用フィットネスジム30分のサーキットトレーニング,
        facilities: [AppLocalizations.of(context)!.gym_サーキットマシン, AppLocalizations.of(context)!.gym_女性専用, AppLocalizations.of(context)!.gym_ストレッチエリア],
      ...
      Gym(
        ...
        latitude: 35.6284,
        longitude: 139.7387,
        description: AppLocalizations.of(context)!.gym_24時間利用可能な格安フィットネスジム,
        facilities: [AppLocalizations.of(context)!.gym_筋トレマシン, AppLocalizations.of(context)!.gym_ランニングマシン, AppLocalizations.of(context)!.gym_フリーウェイト, AppLocalizations.of(context)!.gym_シャワー],
        ...
        isPartner: true,  // β版パートナー
        partnerBenefit: AppLocalizations.of(context)!.gym_月会費初月500体験無料,
      ...
      Gym(
        ...
        latitude: 35.6627,
        longitude: 139.7290,
        description: AppLocalizations.of(context)!.gym_最新設備を完備した都心型フィットネスクラブ,
        facilities: [AppLocalizations.of(context)!.gym_筋トレマシン, AppLocalizations.of(context)!.gym_スタジオ, AppLocalizations.of(context)!.gym_プール, AppLocalizations.of(context)!.gym_ヨガルーム, AppLocalizations.of(context)!.gym_サウナ],
      ...
      Gym(
        ...
        latitude: 35.6719,
        longitude: 139.7646,
        description: AppLocalizations.of(context)!.gym_銀座の中心地にある高級感あふれるフィットネスクラブ,
        facilities: [AppLocalizations.of(context)!.gym_筋トレマシン, AppLocalizations.of(context)!.gym_プール, AppLocalizations.of(context)!.gym_スパ, AppLocalizations.of(context)!.gym_エステ, AppLocalizations.of(context)!.gym_ラウンジ],
      ...
      Gym(
        ...
        latitude: 35.6467,
        longitude: 139.7109,
        description: AppLocalizations.of(context)!.gym_恵比寿駅直結の便利な総合フィットネスクラブ,
        facilities: [AppLocalizations.of(context)!.gym_筋トレマシン, AppLocalizations.of(context)!.gym_スタジオ, AppLocalizations.of(context)!.gym_プール, AppLocalizations.of(context)!.gym_ホットヨガ, AppLocalizations.of(context)!.gym_カフェ],
      ...
      Gym(
        ...
        latitude: 35.6984,
        longitude: 139.7731,
        description: AppLocalizations.of(context)!.gym_秋葉原駅近くの24時間営業ジムビジネスマンに人気,
        facilities: [AppLocalizations.of(context)!.gym_筋トレマシン, AppLocalizations.of(context)!.gym_ランニングマシン, AppLocalizations.of(context)!.gym_フリーウェイト, AppLocalizations.of(context)!.gym_シャワー],
      ...
      Gym(
        ...
        latitude: 35.6650,
        longitude: 139.7123,
        description: AppLocalizations.of(context)!.gym_完全個室のパーソナルトレーニングジム結果にコミット,
        facilities: [AppLocalizations.of(context)!.gym_個室トレーニングルーム, AppLocalizations.of(context)!.gym_フリーウェイト, AppLocalizations.of(context)!.gym_シャワー, AppLocalizations.of(context)!.gym_専属トレーナー],
      ...
      Gym(
        ...
        latitude: 35.6331,
        longitude: 139.7157,
        description: AppLocalizations.of(context)!.gym_目黒駅徒歩3分充実した設備とプログラム,
        facilities: [AppLocalizations.of(context)!.gym_筋トレマシン, AppLocalizations.of(context)!.gym_プール, AppLocalizations.of(context)!.gym_スタジオ, AppLocalizations.of(context)!.gym_テニスコート, AppLocalizations.of(context)!.gym_スカッシュ],
      ...
      Gym(
        ...
        latitude: 35.7074,
        longitude: 139.7748,
        description: AppLocalizations.of(context)!.gym_上野エリア最大級の24時間フィットネスジム,
        facilities: [AppLocalizations.of(context)!.gym_筋トレマシン, AppLocalizations.of(context)!.gym_ランニングマシン, AppLocalizations.of(context)!.gym_フリーウェイト, AppLocalizations.of(context)!.gym_ストレッチエリア, AppLocalizations.of(context)!.gym_シャワー],
      ...
      Gym(
        ...
        latitude: 35.6741,
        longitude: 139.7370,
        description: AppLocalizations.of(context)!.gym_アメリカ発の話題のグループトレーニングスタジオ,
        facilities: [AppLocalizations.of(context)!.workout_トレッドミル, AppLocalizations.of(context)!.workout_ローイングマシン, AppLocalizations.of(context)!.gym_フリーウェイト, AppLocalizations.of(context)!.gym_グループスタジオ],
      ...
      Gym(
        ...
        latitude: 35.7032,
        longitude: 139.5796,
        description: AppLocalizations.of(context)!.gym_女性専用30分フィットネス気軽に通える環境,
        facilities: [AppLocalizations.of(context)!.gym_サーキットマシン, AppLocalizations.of(context)!.gym_女性専用, AppLocalizations.of(context)!.gym_ストレッチエリア, AppLocalizations.of(context)!.gym_無料体験],
      ...
      Gym(
        ...
        latitude: 35.6435,
        longitude: 139.6693,
        description: AppLocalizations.of(context)!.gym_家族で通える総合スポーツクラブキッズスクールも充実,
        facilities: [AppLocalizations.of(context)!.gym_筋トレマシン, AppLocalizations.of(context)!.gym_プール, AppLocalizations.of(context)!.gym_スタジオ, AppLocalizations.of(context)!.gym_キッズルーム, AppLocalizations.of(context)!.gym_スパ, AppLocalizations.of(context)!.gym_テニス],
      ...
      Gym(
        id: '16',
        name: AppLocalizations.of(context)!.gym_マッスルハウスGYM,
        address: '静岡県藤枝市末広4丁目1-17',
        latitude: 34.8660,
        longitude: 138.2589,
        description: AppLocalizations.of(context)!.gym_合戸孝二氏のパーソナルトレーニングを受けられる本格派ジム日本を4度制覇しアジアをも制覇した狂気のトレ,
        facilities: [AppLocalizations.of(context)!.gym_フリーウェイト, AppLocalizations.of(context)!.gym_パワーラック, AppLocalizations.of(context)!.gym_本格マシン, AppLocalizations.of(context)!.gym_パーソナル指導],
        phoneNumber: '054-635-2775',
        openingHours: AppLocalizations.of(context)!.gym_要予約制,
        monthlyFee: 15000,
        rating: 4.7,
        reviewCount: 10,
      ...
      Gym(
        id: '17',
        name: AppLocalizations.of(context)!.gym_ジュラシックアカデミー,
        address: '愛知県名古屋市港区明正1丁目200 県番地',
        latitude: 35.0806,
        longitude: 136.8664,
        description: AppLocalizations.of(context)!.gym_名古屋のトレーニーの聖地男女ベルを問わずトレーニング初心者の方から上級者トップアスリートステージ競技,
        facilities: [AppLocalizations.of(context)!.gym_本格フリーウェイト, AppLocalizations.of(context)!.gym_パワーリフティング設備, AppLocalizations.of(context)!.gym_ボディビル専門, AppLocalizations.of(context)!.gym_上級者向け],
        phoneNumber: '052-746-7210',
        openingHours: AppLocalizations.of(context)!.gym_営業中2300まで,
        monthlyFee: 12000,
        rating: 4.8,
        reviewCount: 45,
