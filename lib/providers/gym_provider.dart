  ...
  void _loadSampleData() {
    _gyms = [
      ...
      Gym(
        ...
        latitude: 34.8660,
        longitude: 138.2589,
        description: '合戸孝二氏のパーソナルトレーニングを受けられる本格派ジム。日本を4度制覇しアジアをも制覇した狂気のトレーニングを体験せよ！',
        facilities: ['フリーウェイト', 'パワーラック', '本格マシン', 'パーソナル指導'],
      ...
      Gym(
        ...
        latitude: 35.0806,
        longitude: 136.8664,
        description: '名古屋のトレーニーの聖地。男女・ベルを問わずトレーニング初心者の方から上級者、トップアスリート、ステージ競技選手、またより高いレベルの肉体改造を習得したいと思われているトレーナーの方まで。',
        facilities: ['本格フリーウェイト', 'パワーリフティング設備', 'ボディビル専門', '上級者向け'],
        phoneNumber: '052-746-7210',
        openingHours: '営業中（23:00まで）',
        monthlyFee: 12000,
        rating: 4.8,
        reviewCount: 45,
