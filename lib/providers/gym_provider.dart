...
class GymProvider with ChangeNotifier {
  ...
  void _loadSampleData() {
    _gyms = [
      Gym(
        id: '1',
        name: AppLocalizations.of(context)!.gym_f716c672,
        ...
        currentCrowdLevel: 2,
        lastCrowdUpdate: DateTime.now().subtract(Duration(minutes: 15)),
        isPartner: true,  // β版パートナー
        partnerBenefit: AppLocalizations.of(context)!.gym_b6f4f89a,
        partnerSince: DateTime.now().subtract(Duration(days: 7)),
      ),
      Gym(
        id: '2',
        name: AppLocalizations.of(context)!.gym_0375482c,
        address: AppLocalizations.of(context)!.generatedKey_bc683976,
        latitude: 35.6598,
        longitude: 139.7035,
        ...
        updatedAt: DateTime.now(),
        currentCrowdLevel: 4,
        lastCrowdUpdate: DateTime.now().subtract(Duration(minutes: 5)),
      ),
      Gym(
        id: '3',
        name: AppLocalizations.of(context)!.gym_6de2294c,
        address: AppLocalizations.of(context)!.generatedKey_4aa5738e,
        latitude: 35.7295,
        longitude: 139.7190,
        ...
        openingHours: AppLocalizations.of(context)!.generatedKey_4de56b94,
        monthlyFee: 10890,
        rating: 4.3,
        reviewCount: 89,
        ...
        updatedAt: DateTime.now(),
        currentCrowdLevel: 3,
        lastCrowdUpdate: DateTime.now().subtract(Duration(minutes: 20)),
      ),
      Gym(
        id: '4',
        name: AppLocalizations.of(context)!.gym_85211fa9,
        address: AppLocalizations.of(context)!.generatedKey_1c8c24e4,
        latitude: 35.7072,
        longitude: 139.6656,
        ...
        openingHours: AppLocalizations.of(context)!.generatedKey_9d9f1062,
        monthlyFee: 6820,
        rating: 4.6,
        reviewCount: 142,
        ...
        updatedAt: DateTime.now(),
        currentCrowdLevel: 1,
        lastCrowdUpdate: DateTime.now().subtract(Duration(minutes: 10)),
      ),
      Gym(
        id: '5',
        name: AppLocalizations.of(context)!.gym_57718274,
        address: AppLocalizations.of(context)!.generatedKey_2888fd46,
        latitude: 35.6284,
        longitude: 139.7387,
        ...
        updatedAt: DateTime.now(),
        currentCrowdLevel: 5,
        lastCrowdUpdate: DateTime.now().subtract(Duration(minutes: 2)),
        isPartner: true,  // β版パートナー
        partnerBenefit: AppLocalizations.of(context)!.gym_3158b409,
        partnerSince: DateTime.now().subtract(Duration(days: 3)),
      ),
      Gym(
        id: '6',
        name: AppLocalizations.of(context)!.gym_33bbb5ab,
        address: AppLocalizations.of(context)!.generatedKey_fcd4b3e5,
        latitude: 35.6627,
        longitude: 139.7290,
        ...
        openingHours: AppLocalizations.of(context)!.generatedKey_32111117,
        monthlyFee: 12800,
        rating: 4.4,
        reviewCount: 178,
        ...
        updatedAt: DateTime.now(),
        currentCrowdLevel: 3,
        lastCrowdUpdate: DateTime.now().subtract(Duration(minutes: 8)),
      ),
      Gym(
        id: '7',
        name: AppLocalizations.of(context)!.gym_c008dece,
        address: AppLocalizations.of(context)!.generatedKey_f048637d,
        latitude: 35.6719,
        longitude: 139.7646,
        ...
        openingHours: AppLocalizations.of(context)!.generatedKey_4c2cf3c5,
        monthlyFee: 15400,
        rating: 4.8,
        reviewCount: 312,
        imageUrl: 'https://via.placeholder.com/400x200?text=Central+Sports',
        createdAt: DateTime.now().subtract(Duration(days: 800)),
        updatedAt: DateTime.now(),
        currentCrowdLevel: 2,
        lastCrowdUpdate: DateTime.now().subtract(Duration(minutes: 12)),
      ),
      Gym(
        id: '8',
        name: AppLocalizations.of(context)!.gym_86ce6091,
        address: AppLocalizations.of(context)!.generatedKey_c124aee1,
        latitude: 35.6467,
        longitude: 139.7109,
        ...
        openingHours: AppLocalizations.of(context)!.generatedKey_e0b4ddc7,
        monthlyFee: 11900,
        rating: 4.5,
        reviewCount: 203,
        imageUrl: 'https://via.placeholder.com/400x200?text=Renaissance',
        createdAt: DateTime.now().subtract(Duration(days: 600)),
        updatedAt: DateTime.now(),
        currentCrowdLevel: 4,
        lastCrowdUpdate: DateTime.now().subtract(Duration(minutes: 3)),
      ),
      Gym(
        id: '9',
        name: AppLocalizations.of(context)!.gym_44fdaff8,
        address: AppLocalizations.of(context)!.generatedKey_db31f61d,
        latitude: 35.6984,
        longitude: 139.7731,
        ...
        createdAt: DateTime.now().subtract(Duration(days: 280)),
        updatedAt: DateTime.now(),
        currentCrowdLevel: 3,
        lastCrowdUpdate: DateTime.now().subtract(Duration(minutes: 18)),
      ),
      Gym(
        id: '10',
        name: AppLocalizations.of(context)!.gym_f9fd702a,
        address: AppLocalizations.of(context)!.generatedKey_676c2355,
        latitude: 35.6650,
        longitude: 139.7123,
        ...
        openingHours: AppLocalizations.of(context)!.generatedKey_321b4011,
        monthlyFee: 149600,
        rating: 4.9,
        reviewCount: 89,
        imageUrl: 'https://via.placeholder.com/400x200?text=RIZAP',
        createdAt: DateTime.now().subtract(Duration(days: 550)),
        updatedAt: DateTime.now(),
        currentCrowdLevel: 1,
        lastCrowdUpdate: DateTime.now().subtract(Duration(minutes: 25)),
      ),
      Gym(
        id: '11',
        name: AppLocalizations.of(context)!.gym_29212c38,
        address: AppLocalizations.of(context)!.generatedKey_8b05e16b,
        latitude: 35.6331,
        longitude: 139.7157,
        ...
        openingHours: AppLocalizations.of(context)!.generatedKey_fb8dbbe7,
        monthlyFee: 13500,
        rating: 4.6,
        reviewCount: 187,
        imageUrl: 'https://via.placeholder.com/400x200?text=Megalos',
        createdAt: DateTime.now().subtract(Duration(days: 650)),
        updatedAt: DateTime.now(),
        currentCrowdLevel: 2,
        lastCrowdUpdate: DateTime.now().subtract(Duration(minutes: 7)),
      ),
      Gym(
        id: '12',
        name: AppLocalizations.of(context)!.gym_fdc406e9,
        address: AppLocalizations.of(context)!.generatedKey_10ebc5f2,
        latitude: 35.7074,
        longitude: 139.7748,
        ...
        updatedAt: DateTime.now(),
        currentCrowdLevel: 4,
        lastCrowdUpdate: DateTime.now().subtract(Duration(minutes: 6)),
      ),
      Gym(
        id: '13',
        name: AppLocalizations.of(context)!.gym_040117b0,
        address: AppLocalizations.of(context)!.generatedKey_1632e713,
        latitude: 35.6741,
        longitude: 139.7370,
        ...
        openingHours: AppLocalizations.of(context)!.generatedKey_7d9ae744,
        monthlyFee: 18700,
        rating: 4.7,
        reviewCount: 156,
        ...
        updatedAt: DateTime.now(),
        currentCrowdLevel: 3,
        lastCrowdUpdate: DateTime.now().subtract(Duration(minutes: 14)),
      ),
      Gym(
        id: '14',
        name: AppLocalizations.of(context)!.gym_e367b91d,
        address: AppLocalizations.of(context)!.generatedKey_dd209f8a,
        latitude: 35.7032,
        longitude: 139.5796,
        ...
        openingHours: AppLocalizations.of(context)!.generatedKey_bb5a94a5,
        monthlyFee: 6820,
        rating: 4.5,
        reviewCount: 198,
        imageUrl: 'https://via.placeholder.com/400x200?text=Curves+Kichijoji',
        createdAt: DateTime.now().subtract(Duration(days: 320)),
        updatedAt: DateTime.now(),
        currentCrowdLevel: 1,
        lastCrowdUpdate: DateTime.now().subtract(Duration(minutes: 22)),
      ),
      Gym(
        id: '15',
        name: AppLocalizations.of(context)!.gym_c757a779,
        address: AppLocalizations.of(context)!.generatedKey_aeacdbe7,
        latitude: 35.6435,
        longitude: 139.6693,
        ...
        openingHours: AppLocalizations.of(context)!.generatedKey_386a19ab,
        monthlyFee: 10200,
        rating: 4.4,
        reviewCount: 224,
        ...
        updatedAt: DateTime.now(),
        currentCrowdLevel: 2,
        lastCrowdUpdate: DateTime.now().subtract(Duration(minutes: 11)),
      ),
      // トレーニーの聖地
      Gym(
        id: '16',
        name: AppLocalizations.of(context)!.gym_15550205,
        address: AppLocalizations.of(context)!.generatedKey_d363c8dd,
        latitude: 34.8660,
        longitude: 138.2589,
        ...
        createdAt: DateTime.now().subtract(Duration(days: 1500)),
        updatedAt: DateTime.now(),
        currentCrowdLevel: 2,
        lastCrowdUpdate: DateTime.now().subtract(Duration(minutes: 30)),
      ),
      Gym(
        id: '17',
        name: AppLocalizations.of(context)!.gym_14215715,
        address: AppLocalizations.of(context)!.gym_96e68737,
        latitude: 35.0806,
        longitude: 136.8664,
