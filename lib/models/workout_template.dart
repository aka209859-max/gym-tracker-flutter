...
class DefaultTemplates {
  ...
  static WorkoutTemplate pplPush(String userId) {
    return WorkoutTemplate(
      ...
      description: AppLocalizations.of(context)!.workout_プッシュ系種目を集中的に鍛えるテンプレート,
  ...
  static WorkoutTemplate pplPull(String userId) {
    return WorkoutTemplate(
      ...
      description: AppLocalizations.of(context)!.workout_プル系種目を集中的に鍛えるテンプレート,
  ...
  static WorkoutTemplate pplLegs(String userId) {
    return WorkoutTemplate(
      ...
      userId: userId,
      name: 'PPL - Legs Day（脚）',
      description: AppLocalizations.of(context)!.workout_下半身を徹底的に鍛えるテンプレート,
  ...
  static WorkoutTemplate fullBodyBeginner(String userId) {
    return WorkoutTemplate(
      ...
      userId: userId,
      name: 'フルボディ - 初心者向け',
      description: AppLocalizations.of(context)!.workout_全身をバランスよく鍛える初心者向けテンプレート,
      muscleGroup: AppLocalizations.of(context)!.bodyPartChest,
      isDefault: true,
      createdAt: DateTime.now(),
      exercises: [
  ...
  static WorkoutTemplate upperBodyFocus(String userId) {
    return WorkoutTemplate(
      ...
      userId: userId,
      name: AppLocalizations.of(context)!.workout_上半身特化トレーニング,
      description: AppLocalizations.of(context)!.bodyPart_胸背中肩を集中的に鍛えるテンプレート,
      muscleGroup: AppLocalizations.of(context)!.bodyPartChest,
      isDefault: true,
      createdAt: DateTime.now(),
      exercises: [
