...
class GooglePlace {
  ...
  Map<String, dynamic> toGymCompatible() {
    return {
      ...
      'openingHours': openNow == true ? AppLocalizations.of(context)!.open : openNow == false ? AppLocalizations.of(context)!.general_営業時間外 : AppLocalizations.of(context)!.general_営業時間不明,
