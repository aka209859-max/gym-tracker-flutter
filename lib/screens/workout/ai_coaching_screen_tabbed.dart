...
class _AIMenuTabState extends State<_AIMenuTab>
  ...
  /// 🔧 v1.0.218: 実在するトレーニング種目データベース（ハルシネーション防止）
  static const String _exerciseDatabase = '''
【実在するトレーニング種目一覧】必ずこの中から選択してください。

■胸（大胸筋）:
- ベンチプレス（バーベル/ダンベル/スミスマシン）
- インクラインベンチプレス
- デクラインベンチプレス
- チェストプレスマシン
- ダンベルフライ/インクラインフライ
...
**重要**: 上記以外の架空の種目は提案しないこと。種目名は正確に記載すること。
''';

  /// 🔧 v1.0.217: プロンプト構築（レベル別 + トレーニング履歴考慮 + v1.0.218: 種目DB追加）
