...
2. トライセプスプレスダウン
   説明: ケーブルマシンでバーを下に押し下げる。上腕三頭筋（二の腕）を鍛える。
...
■腕（上腕二頭筋・上腕三頭筋）:
バーベルカール（ストレート）、EZバーカール、ダンベルカール（オルタネイト）、ハンマーカール、プリチャーカール、ケーブルカール、トライセプスプレスダウン、ライイングトライセプスエクステンション、オーバーヘッドトライセプスエクステンション、ディップス（三頭筋重視）、キックバック、クローズグリップベンチプレス
