...
class FatigueManagementService {
  ...
  /// 戻り値: {
  ///   'level': 1-5,
  ///   'label': AppLocalizations.of(context)!.general_軽度 | AppLocalizations.of(context)!.general_中程度 | AppLocalizations.of(context)!.general_高め | AppLocalizations.of(context)!.general_極めて高い,
  ///   'color': Color,
  ...
  Map<String, dynamic> getFatigueLevel(double trainingLoad) {
    ...
    if (trainingLoad < 300) {
      ...
      return {
        'level': 1,
        'label': AppLocalizations.of(context)!.general_軽度,
        'color': 'green',
        'recoveryHours': 24,
      ...
      return {
        'level': 2,
        'label': AppLocalizations.of(context)!.general_中程度,
        'color': 'blue',
        'recoveryHours': 36,
      ...
      return {
        'level': 3,
        'label': AppLocalizations.of(context)!.general_高め,
        'color': 'orange',
        'recoveryHours': 48,
      ...
      return {
        'level': 4,
        'label': AppLocalizations.of(context)!.general_極めて高い,
        'color': 'red',
        'recoveryHours': 72,
